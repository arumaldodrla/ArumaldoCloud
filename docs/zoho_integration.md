...
| **Zoho Sign** | Electronic signatures for contracts. |
...
### 8.1 Electronic Contracts

When a customer signs up for a plan, they may be required to sign a contract. The contract is generated by Arumaldo Cloud and sent to the customer via Zoho Sign for electronic signature.
